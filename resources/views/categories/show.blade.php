...
<div class="row">
    ...
    <div class="col-md-3">
        <div class="card">
            ...
            <ul class="list-group list-group-flush">
                @foreach($main_category->sub_categories as $sub)
                <a href="{{ route('client.category.show', [$main_category->id, $sub->id]) }}" class="list-group-item list-group-item-action">{{$sub->name}}</a>
                @endforeach
            </ul>
        </div>
    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-header">{{ $sub_category->name }}</div>
            ...
            <div class="card-body">
                ...
                @else
                <div>No Products are available in this category.</div>
                @endif
            </div>
        </div>
    </div>
